...
interval_(pt(A1...A2, Df1...Df2), Res, _Flags) :-
    pt0(A1...A2, Df1...Df2, true, false, Res0),
    !, Res = number(Res0).
...
pt0(A1...A2, _Df1...Df2, true, LogP, Res) :-
    pt_(A1, Df2, true, LogP, L),
    pt_(A2, Df2, true, LogP, U),
    !, Res = L...U.
...
pt0(A1...A2, _Df1...Df2, false, LogP, Res) :-
    pt_(A2, Df2, false, LogP, L),
    pt_(A1, Df2, false, LogP, U),
    !, Res = L...U.    
...
% pt/4 log.p = FALSE
interval_(pt(number(A), number(Df), number(Ncp), bool(Tail)), Res, _Flags) :-
    pt_(A, Df, Ncp, Tail, false, Res0),
    !, Res = number(Res0).

interval_(pt(A1...A2, Df1...Df2, Ncp1...Ncp2, bool(Tail)), Res, _Flags) :-
    pt1(A1...A2, Df1...Df2, Ncp1...Ncp2, Tail, false, Res0),
    !, Res = Res0.
...
% qt/3 lower.tail = TRUE, log.p = TRUE
interval_(qt(number(P), number(Df), number(Ncp)), Res, _Flags) :-
    qt_(P, Df, Ncp, true, false, Res0),
    !, Res = number(Res0).

qt_(P, Df, Ncp, Tail, LogP, Res) :-
    eval(r(qt(P, Df, ncp=Ncp, 'lower.tail'=Tail, 'log.p'=LogP)), Res).

interval_(qt(P1...P2, Df1...Df2, 0...0), Res, _Flags) :-
    qt0(P1...P2, Df1...Df2, true, false, Res0),
    !, Res = Res0.

interval_(qt(P1...P2, Df1...Df2, Ncp1...Ncp2), Res, _Flags) :-
    eval_min_max(qt, [P1...P2, Df1...Df2, Ncp1...Ncp2], Res0),
    !, Res = Res0.

macro(qt/3, interval_, []).

% qt/3 ncp = 0, log.p = TRUE
...
% qt/4 log.p = FALSE
interval_(qt(number(P), number(Df), number(Ncp), bool(Tail)), Res, _Flags) :-
    qt_(P, Df, Ncp, Tail, false, Res0),
    !, Res = number(Res0).

interval_(qt(P1...P2, Df1...Df2, Ncp1...Ncp2, bool(Tail)), Res, _Flags) :-
    eval_min_max(qt, [P1...P2, Df1...Df2, Ncp1...Ncp2, 'lower.tail'=Tail], Res0),
    !, Res = Res0.
